  ...
  {:mw20
   {:en
    (list
     ...
     [:p "Moving Walls 20 deadline: Monday, April 30, 2012, 5 p.m. EST."]
   ...
   {:en
    ...
    (list
     ...
     [:p "Если у Вас возникли вопросы, пожалуйста, обращайтесь к Анне Overstrom-Коулман, ассистент программы, в 212-506-0009 или " (link-to "mailto:rstrom-coleman@sorosny.org" "rstrom-coleman@sorosny.org") "."]
